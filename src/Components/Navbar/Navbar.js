...
const Navbar = () => {
    const [isMainListVisible, setMainListVisible] = useState(false);
    ...
    const dropdownHandler = (element) => {
        if (childRef.current) {
            childRef.current.classList.toggle('hidden');
        }
        console.log(childRef.current);
    };

    const menuHandler = (el, val) => {
        const mainList = el.parentElement.parentElement.getElementsByTagName("ul")[0];
        const closeIcon = el.parentElement.parentElement.getElementsByClassName("close-m-menu")[0];
        const showIcon = el.parentElement.parentElement.getElementsByClassName("show-m-menu")[0];
    ...
    return (
        <>
            ...
            <div className="h-full w-full">
                ...
                <nav role="navigation" className="bg-black h-18 shadow xl:block hidden">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="inset-y-0 left-0 flex items-center xl:hidden">
                                <div className="inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-gray-100 focus:outline-none transition duration-150 ease-in-out">
                                    <div className="visible xl:hidden">
                                        <ul className="profile-drop-down-show p-2 border-r bg-white absolute rounded left-0 right-0 shadow mt-8 md:mt-8 hidden">
                                            <li className="flex xl:hidden cursor-pointer text-white text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="ml-2 text-white font-bold">Categories</span>
                                                </div>
                                            </li>
                                            <li
                                                ...
                                                onClick={(e) => console.log('sdhlsdjbn;jdsfb: ', e)}
                            ...
                            <button className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 rounded-md flex w-full sm:w-auto items-center sm:items-stretch justify-end sm:justify-start">
                                <div className="flex ml-16 items-center">
                                    ...
                                    <h2 className="hidden sm:block text-base text-white font-bold leading-normal px-3">
                                        Reviewify
                                    </h2>
                                </div>
                            </button>
                            ...
                            <div className="flex">
                                <div className="hidden text-white xl:flex md:mr-6 xl:mr-4">
                                    <a
                                        href="javascript: void(0)"
                                        className="focus:text-gray-100 font-semibold border-b-2 text-whtie border-transparent focus:border-indigo-700 flex px-5 items-center py-6  text-sm leading-5 text-whtie hover:bg-gray-900 focus:bg-gray-900 focus:outline-none transition duration-150 ease-in-out"
                                    >
                                        <span className="mr-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                className="icon text-white icon-tabler icon-tabler-grid"
                                                width={20}
                                                height={20}
                                                viewBox="0 0 24 24"
                                                strokeWidth="1.5"
                                    ...
                                    <a
                                        href="javascript: void(0)"
                                        className="focus:text-gray-100 font-semibold border-b-2 border-transparent focus:border-indigo-700 flex px-5 items-center py-6 text-sm  leading-5 text-whtie hover:bg-gray-900 focus:bg-gray-900 focus:outline-none transition duration-150 ease-in-out"
                                    >
                                        <span className="mr-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    {/* <a
              href="javascript: void(0)"
              className="focus:text-gray-100  border-b-2 border-transparent focus:border-indigo-700 flex px-5 items-center py-6  text-md leading-5 text-whtie hover:bg-gray-900 focus:bg-gray-100 focus:outline-none transition duration-150 ease-in-out"
            >
              <span className="mr-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              Performance
                                ...
                                <div className="hidden xl:flex items-center">
                                    <div className="relative md:mr-6 my-2">
                                        <Link to={"/"}>
                                        <button className="focus:ring-2 h-10 focus:text-white focus:outline-none font-semibold  hover:bg-[#84a5e3] text-white rounded-lg border-[#A6C0F0] border transition duration-150 ease-in-out  rounded   px-5 py-2 text-xs">
                                            FeedBacks
                                        </button>
                                        </Link>
                                    </div>
                                    <div className="ml-6 relative">
                                        <button
                                            ...
                                            onClick={(e) => dropdownHandler(e)}
                                        >
                                            <ul ref={childRef} className="drop-urlll p-2 w-40 border-r bg-black absolute rounded right-0 shadow top-0 mt-16 hidden">
                                                <li className="cursor-pointer text-gray-300 text-sm leading-3 tracking-normal py-2 hover:text-white focus:text-indigo-700 focus:outline-none">
                                                    <a
                                                        href=""
                                                ...
                                                <li className="cursor-pointer text-gray-300 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-white focus:text-indigo-700 focus:outline-none flex items-center">
                                                    <a
                                                        href="javascript:void(0)"
                                                        className="focus:underline focus:text-indigo-700 focus:outline-none flex items-center"
                                                    >
                                                ...
                                                <li className="cursor-pointer text-gray-300 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-white flex items-center focus:text-indigo-700 focus:outline-none">
                                                    <a
                                                        href="javascript:void(0)"
                                                        className="focus:underline focus:text-indigo-700 focus:outline-none flex items-center"
                                                    >
                    ...
                    <div className="py-4 px-6 w-full flex xl:hidden justify-between items-center bg-black fixed top-0 z-40">
                        ...
                        <div className="flex items-center">
                            <div className="relative mr-6">
                                <button className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none  border-gray-300 border transition duration-150 ease-in-out h-10 hover:bg-gray-300 rounded text-gray-600 px-5 py-2 h text-xs focus:text-black focus:outline-none font-semibold  hover:bg-[#84a5e3] text-white rounded-lg border-[#A6C0F0]">
                                    For businesses
                                </button>
                            </div>
                            <button
                            ...
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="icon text-white icon-tabler icon-tabler-menu-2"
                                    width={24}
                                    height={24}
                                    viewBox="0 0 24 24"
                                    strokeWidth="1.5"
                                        ...
                                        <div className="mt-6  flex w-full items-center justify-between">
                                            <div className="flex items-center justify-between w-full">
                                                <div className="flex items-center">
                                                    ...
                                                    <p
                                                        tabIndex={0}
                                                        className="focus:outline-none text-base md:text-2xl text-white ml-3"
                                                    >
                                                        Reviewify
                                                    </p>
                                                </div>
                                                ...
                                                <a className="cursor-pointer">
                                                    <div className="text-white pt-10">
                                                        <div className="flex items-center">
                                                            ...
                                                            <p
                                                                tabIndex={0}
                                                                className="focus:outline-none focus:text-white text-gray-300 hover-text-white xl:text-base text-base ml-3"
                                                            >
                                                                Categories
                                                            </p>
                                                        </div>
                                                        ...
                                                        <div className="flex items-center justify-between">
                                                            <div className="flex items-center">
                                                                <div className="w-6 h-6 md:w-8 md:h-8 text-gray-800">
                                                                    <svg
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        className="icon text-white icon-tabler icon-tabler-puzzle"
                                                                        viewBox="0 0 24 24"
                                                                        strokeWidth="1.5"
                                                                        stroke="currentColor"
                                                                        fill="none"
                                                                ...
                                                                <p
                                                                    tabIndex={0}
                                                                    className="focus:outline-none focus:text-white text-gray-300 hover-text-white xl:text-base md:text-2xl text-base ml-3"
                                                                >
                                                                    Blog
                                                                </p>
                                                            </div>
                                                    ...
                                                    <div className="text-gray-800 pt-8">
                                                        <div className="flex items-center">
                                                            <div className="w-6 h-6 md:w-8 md:h-8 text-gray-800">
                                                                <svg
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    className="icon text-white icon-tabler icon-tabler-compass"
                                                                    viewBox="0 0 24 24"
                                                                    strokeWidth="1.5"
                                                                    stroke="currentColor"
                                                                    fill="none"
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center">
                                                        <div className="w-6 h-6 md:w-8 md:h-8 text-gray-800">
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                className="icon text-white icon-tabler icon-tabler-code"
                                                                viewBox="0 0 24 24"
                                                                strokeWidth="1.5"
                                                                stroke="currentColor"
                                                                fill="none"
                                        ...
                                        <div className="flex justify-center mb-4 w-full">
                                            <div className="relative w-full">
                                                <div className="text-gray-500 absolute ml-4 inset-0 m-auto w-4 h-4">
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        className="icon text-white icon-tabler icon-tabler-search"
                                                        width={16}
                                                        height={16}
                                                        viewBox="0 0 24 24"
                                                        strokeWidth={1}
                                        ...
                                        <div className="border-t border-gray-300">
                                            <div className="w-full flex items-center justify-between pt-1">
                                                <div className="flex items-center">
                                                    ...
                                                    <p
                                                        tabIndex={0}
                                                        className="focus:outline-none text-white text-base leading-4 ml-2"
                                                    >
                                                        Jane Doe
                                                    </p>
                                                </div>
                                                <ul className="flex">
                                                    <li className="cursor-pointer text-gray-800 pt-5 pb-3">
                                                        ...
                                                        >
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                className="icon text-white icon-tabler icon-tabler-messages"
                                                                viewBox="0 0 24 24"
                                                                strokeWidth={1}
                                                                stroke="currentColor"
                                                                fill="none"
                                                    ...
                                                    <li className="cursor-pointer text-gray-800 pt-5 pb-3 pl-3">
                                                        ...
                                                        >
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                className="icon text-white icon-tabler icon-tabler-bell"
                                                                viewBox="0 0 24 24"
                                                                strokeWidth={1}
                                                                stroke="currentColor"
                                                                fill="none"
